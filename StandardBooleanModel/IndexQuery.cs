internal sealed class IndexQuery
{
    ...
    private sealed class Parser
    {
        ...
        public Parser(List<Token> tokens, IndexQuery query)
        {
            _tokens = tokens;
            _query = query;
        }
        ...
        private HashSet<string> ParseUnaryExpression()
        {
            ...
            {
                return _query.GetTermSet(token.Value);
            }
